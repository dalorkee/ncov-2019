...
class WalkInCaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
          ...
          "risk2_6arrive_date" => (!empty($request->risk2_6ArriveDate)) ? $this->Convert_Date($request->risk2_6ArriveDate) : "",
          ...
          "data3_1date_sickdate" => (!empty($request->risk3_1sickDateInput)) ? $this->Convert_Date($request->risk3_1sickDateInput) : "",
          ...
          "lab_send_date" => (!empty($request->lab_send_date)) ? $this->Convert_Date($request->lab_send_date) : "",
