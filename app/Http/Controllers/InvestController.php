	...
	*/
	...
	public function store(Request $request) {
		...
		$request->validate([
			...
			'labCbcHb' => 'nullable|max:9',
			'labCbcHct' => 'nullable|max:9',
			'labCbcPlateletCount' => 'nullable|max:9',
			'labCbcWbc' => 'nullable|max:9',
			'labCbcNeutrophil' => 'nullable|max:9',
			'labCbcLymphocyte' => 'nullable|max:9',
			'lab_cbc_atyp_lymph' => 'nullable|max:9',
			'lab_cbc_mono' => 'nullable|max:9',
			'lab_cbc_other' => 'max:50',
			'lab_rapid_test_method' => 'max:40',
			'firstDiagInput' => 'max:3000',
			'covid19_drug_medicate_name_other' => 'max:60',
			'patient_treat_status_refer' => 'max:50',
			'patient_treat_status_other' => 'max:50',
			'risk_detail' => 'max:20000',
			'risk_type_text' => 'max:20000',
			...
			'risk_other' => 'max:20000',
			'invest_note' => 'max:20000',
		],[
