...
class ScreenPUIController extends MasterController
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
          ...
          // "nps_ts1_send" => (!empty($request->nps_ts1_send)) ? trim($request->nps_ts1_send) : NULL,
          // "nps_ts1_result" => (!empty($request->nps_ts1_result)) ? trim($request->nps_ts1_result) : NULL,
          // "nps_ts1_result_date" => (!empty($request->nps_ts1_result_date)) ? $this->Convert_Date($request->nps_ts1_result_date) : NULL,
          // "nps_ts1_result2" => (!empty($request->nps_ts1_result2)) ? $request->nps_ts1_result2 : NULL,
          ...
          // "nps_ts2_result" => (!empty($request->nps_ts2_result)) ? trim($request->nps_ts2_result) : NULL,
          // "nps_ts2_result_date" => (!empty($request->nps_ts2_result_date)) ? $this->Convert_Date($request->nps_ts2_result_date) : NULL,
          // "nps_ts2_result2" => (!empty($request->nps_ts2_result2)) ? $request->nps_ts2_result2 : NULL,
          ...
          // "nps_ts3_result" => (!empty($request->nps_ts3_result)) ? trim($request->nps_ts3_result) : NULL,
          // "nps_ts3_result_date" => (!empty($request->nps_ts3_result_date)) ? $this->Convert_Date($request->nps_ts3_result_date) : NULL,
          // "nps_ts3_result2" => (!empty($request->nps_ts3_result2)) ? $request->nps_ts3_result2 : NULL,
          ...
          // "cb_result" => (!empty($request->cb_result)) ? trim($request->cb_result) : NULL,
