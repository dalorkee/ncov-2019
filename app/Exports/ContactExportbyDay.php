...
class ContactExportbyDay  implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function __construct($data) {
      $this->risk_contact = array_pull($data, 'risk_contact');
      $this->created_date1 = array_pull($data, 'created_date1');
      $this->created_date2 = array_pull($data, 'created_date2');
    }
          ...
          switch ($user_role) {
            case 'hos':
              $contact_data  = $contact_data_val
                      ->orwhere('tbl_contact.province',$uid_prov_code)
                      ->wherein('tbl_contact.risk_contact',$this->risk_contact)
                      ->whereBetween('patient_relation.create_date', [$this->created_date1, $this->created_date2])
