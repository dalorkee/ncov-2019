					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="idcardInput" value="{{ $invest_pt[0]['card_id'] }}" class="form-control text-danger font-weight-bold font-fira @error('idcardInput') is-invalid @enderror" id="idcardInput">
								@error('idcardInput')
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="passportInput" value="{{ $invest_pt[0]['passport'] }}" class="form-control text-danger font-weight-bold font-fira @error('passportInput') is-invalid @enderror" id="passportInput" id="passport">
								@error('passportInput')
									<div class="alert alert-danger">{{ $message }}</div>
								@enderror
							</div>
