		...
		<div class="form-row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control-inline">
							<input type="checkbox" name="risk_contact_covid_19" value="y" @if ($invest_pt[0]['risk_contact_covid_19'] == 'y') checked @endif class="custom-control-input risk_contact_covid_19" id="risk_contact_covid_19_yes">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<div class="form-group">
					...
					<input type="text" name="risk_contact_covid_19_patient_name" value="{{ $invest_pt[0]['risk_contact_covid_19_patient_name'] }}" class="form-control" placeholder="ชื่อ-นามสกุล ผู้ป่วยยืนยัน">
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<div class="form-group">
					<label for="contact">รหัส SAT ID</label>
					<input type="text" name="risk_contact_covid_19_sat_id" value="{{ $invest_pt[0]['risk_contact_covid_19_sat_id'] }}" class="form-control" placeholder="SAT ID ผู้ป่วยยืนยัน">
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<div class="form-group">
					<label for="">ลักษณะการสัมผัส</label>
					<input type="text" name="risk_contact_covid_19_touch" value="{{ $invest_pt[0]['risk_contact_covid_19_touch'] }}" class="form-control" placeholder="ลักษณะการสัมผัส">
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<div class="form-group">
					<label for="contact">ช่วงระยะเวลาที่มีการสัมผัส</label>
					<input type="text" name="risk_contact_covid_19_duration" value="{{ $invest_pt[0]['risk_contact_covid_19_duration'] }}" class="form-control" placeholder="ช่วงระยะเวลาการสัมผัส (นาที)">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control">
							<input type="checkbox" name="risk_contact_tourist" value="y" @if ($invest_pt[0]['risk_contact_tourist'] == 'y') checked @endif class="custom-control-input chk-risk-contact-tourist" id="risk_contack_tourist_yes">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control">
							<input type="checkbox" name="risk_travel_to_arena" value="y" @if ($invest_pt[0]['risk_travel_to_arena'] == 'y') checked @endif class="custom-control-input risk_travel_to_arena" id="risk_travel_to_arena_yes">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control">
							<input type="checkbox" name="be_patient_cluster" value="y" @if ($invest_pt[0]['be_patient_cluster'] == 'y') checked @endif  class="custom-control-input be_patient_cluster" id="be_patient_cluster_yes">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control">
							<input type="checkbox" name="be_patient_critical_unknown_cause" value="y" @if ($invest_pt[0]['be_patient_critical_unknown_cause'] == 'y') checked @endif class="custom-control-input be_patient_critical_unknown_cause" id="be_patient_critical_unknown_cause_yes">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<div class="card">
						...
						<div class="custom-control custom-checkbox custom-control">
							<input type="checkbox" name="be_health_personel" value="y" @if ($invest_pt[0]['be_health_personel'] == 'y') checked @endif class="custom-control-input be_health_personel" id="be_health_personel_yes">
		...
		<div class="form-row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="form-group">
					...
					<input type="text" name="risk_other" value="{{ $invest_pt[0]['risk_other'] }}" class="form-control" placeholder="ระบุ">
				</div>
			</div>
		</div>
	</section>
