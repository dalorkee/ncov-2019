	...
	<ul class="list-style-none">
			...
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="sickFirstDate" class="text-success">วันที่เริ่มป่วย</label>
						<div class="input-group date" data-provide="datepicker" id="data3_1date_sickdate">
							<div class="input-group">
								<input type="text" name="data3_1date_sickdate" value="{{ $data['data3_1date_sickdate'] }}" class="form-control text-success border-outline border-success">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="provinceSickFirst" class="text-success">จังหวัดที่เริ่มป่วย</label>
						<select name="sick_province_first" class="form-control selectpicker show-tick" data-live-search="true" data-style="btn-outline-success" id="select_sick_province_first">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="districtSickFirst" class="text-success">อำเภอที่เริ่มป่วย</label>
						<select name="sick_district_first" class="form-control selectpicker show-tick" data-style="btn-outline-success" id="select_sick_district_first">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="subDistrictSickFirst" class="text-success">ตำบลที่เริ่มป่วย</label>
						<select name="sick_sub_district_first" class="form-control selectpicker show-tick" data-style="btn-outline-success" id="select_sick_sub_district_first">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="country" class="text-danger">จังหวัดที่รักษาปัจจุบัน</label>
						<select name="treatPlaceProvinceInput" class="form-control selectpicker show-tick text-info" data-live-search="true" data-style="btn btn-outline-danger" id="treat_place_province">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="district" class="text-danger">อำเภอที่รักษาปัจจุบัน</label>
						<select name="treatPlaceDistrictInput" class="form-control selectpicker show-tick text-info" data-live-search="true" data-style="btn btn-outline-danger" id="treat_place_district">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="subDistrict" class="text-danger">ตำบลที่รักษาปัจจุบัน</label>
						<select name="treatPlaceSubDistrictInput" class="form-control selectpicker show-tick text-info" data-live-search="true" data-style="btn btn-outline-danger" id="treat_place_sub_district">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="form-group">
						<label for="currentTreat" class="text-danger">สถานที่รักษาปัจจุบัน</label>
						<select name="treat_place_hospital" class="form-control selectpicker how-tick text-info" ata-live-search="true" data-style="btn btn-outline-danger" id="treatPlaceHospital">
