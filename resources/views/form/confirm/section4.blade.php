<div class="card">
	...
	<ul class="list-style-none">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.2 Chemistry: วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.3 Liver function test: วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.4 Sputum AFB: วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="scDateInput">4.5 Sputum culture: วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.6 Hemoculture: วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.7 CXR: ครั้งที่ 1 วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<label for="dateInput">4.8 CXR: ครั้งที่ 2 วันที่ </label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
					<div class="form-group">
						<label for="rapidtest">4.9 Rapid test สำหรับไข้หวัด วันที่</label>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="rapidtest">4.10 ผลการตรวจห้องปฏิบัติการอื่นๆ ระบุ</label>
						<div class="input-group">
