	...
	<ul class="list-style-none">
			...
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.1 ประวัติการได้รับวัคซีนไข้หวัดใหญ่</label>
						<div class="card">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.2 ใส่ท่อช่วยหายใจ</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.3 ภาวะแทรกซ้อน</label>
						<div>
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.4 การรักษา ได้รับย้าต้านไวรัส</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.5 ในช่วง 14 วันก่อนป่วย ท่านอาศัยอยู่ หรือ มีการเดินทางมาจากพื้นที่ที่มีการระบาด</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.6 ในช่วง 14 วันก่อนป่วย ท่านมีประวัติสัมผัสกับบุคคลที่มาจากพื้นที่ระบาดเช่น ประเทศจีน โปรดระบุรายละเอียดของผู้ที่ท่านมีประวัติสัมผัส</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.7 ในช่วง 14 วันก่อนป่วย ท่านได้รับประทานหรือปรุงอาหารที่ประกอบด้วยสัตว์ป่า เช่น งูหรือค้างคาวหรือไม่</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.8 ในช่วง 14 วันก่อนป่วย ท่านได้มีการสัมผัสสัตว์ปีก โดยการจับ ชำแหละ ฝังกลบ หรือรับประทานสุกๆ ดิบๆ เป็นต้น</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.9 ในช่วง 14 วันก่อนป่วย ท่านพักอาศัยในพื้นที่ที่มีสัตว์ปีกป่วยตายมากผิดปกติ หรือพบเชื้อในสัตว์ปีกหรือสิ่งแวดล้อม</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.10 ในช่วง 14 วันก่อนป่วย ไปตลาดสดที่มีการค้าสัตว์ปีก/สัตว์ป่า/สัตว์เลี้ยงลูกด้วยนม/อาหารทะเล ในเมืองอู่ฮั่น (Wuhan) มณฑลหูเป่ย (Hubei) ประเทศจีน</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.11 ในช่วง 14 วันก่อนป่วย ไปตลาดสดที่มีการค้าสัตว์ปีก/สัตว์ป่า/สัตว์เลี้ยงลูกด้วยนม/อาหารทะเล นอกเหนือจากข้อ 2.10</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.12 ท่านมีประวัติเข้ารับการรักษาหรือเยี่ยมผู้ป่วยในโรงพยาบาลขณะอยู่ที่ประเทศดังกล่าวหรือไม่</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="risk">3.13 ในช่วง 14 วันก่อนป่วย ท่านให้การดูแลหรือสัมผัสใกล้ชิดกับผู้ป่วยอาการคล้ายไข้หวัดใหญ่/ปอดอักเสบหรือไม่</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control-inline">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.14 ในช่วง 14 วันก่อนป่วย ท่านมีประวัติสัมผัสผู้ป่วยปอดอักเสบรุนแรงหรือเสียชีวิตที่หาสาเหตุไม่ได้</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control">
		...
		<li class="card-body border-top">
			<div class="form-row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="form-group">
						<label for="">3.15 ในช่วง 14 วันก่อนป่วย ท่านมีบุคคลใกล้ชิดป่วยอาการคล้ายไข้หวัดใหญ่ หรือมีการระบาดของปอดอักเสบในชุมชน</label>
						<div class="card">
							<div class="custom-control custom-checkbox custom-control">
