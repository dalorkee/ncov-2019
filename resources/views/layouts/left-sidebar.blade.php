	...
	<div class="scroll-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav" class="p-t-30">
				...
				<li class="sidebar-item"> <a href="javascript:void(0)" class="sidebar-link has-arrow waves-effect waves-dark" aria-expanded="false"><i class="fas fa-chart-pie"></i><span class="hide-menu"> Dashboard </span></a>
					<ul aria-expanded="false" class="collapse first-level">
						<li class="sidebar-item"><a href="{{ route('vaccineReport') }}" class="sidebar-link"><i class="mdi mdi-radiobox-marked"></i><span class="hide-menu"> Vaccine</span></a></li>
						<li class="sidebar-item"><a href="{{ route('dashboard') }}" class="sidebar-link"><i class="mdi mdi-radiobox-marked"></i><span class="hide-menu"> Disease situation</span></a></li>
					</ul>
				</li>
