									...
									<div class="form-group row">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-12">
											<div class="form-group">
												...
												<div>
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" value="Y" class="custom-control-input" id="customControlValidation3" {{ old('refer_car') == 'Y' ? 'checked' : ''}} name="refer_car" >
														<label class="custom-control-label" for="customControlValidation3">มี</label>
													</div>
													 <div class="custom-control custom-radio custom-control-inline">
															<input type="radio" value="N" class="custom-control-input" id="customControlValidation4" {{ old('refer_car') == 'N' ? 'checked' : ''}} name="refer_car">
...
$(document).ready(function() {
	...
	$("#customControlValidation_rd1").click(function(){
			$('.screen_type1').show();
			$('.screen_type2').hide();
			$('#walkinplace_hosp_province').val('');
			$('#walkinplace_hosp_code').val('');
	});
