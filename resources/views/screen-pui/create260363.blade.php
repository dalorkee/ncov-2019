									...
									<div class="form-group row">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-4">
											<label for="dowork">หมายเลข Passport</label>
												<input type="text" name="passport" class="form-control" id="passport" value="{{ old('passport') }}" placeholder="หมายเลข Passport">
										</div>
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-4">
											<label for="dowork">HN</label>
												<input type="text" name="hn" class="form-control" id="hn" value="{{ old('hn') }}" placeholder="หมายเลขประจำตัวผู้ป่วย">
										</div>
									</div>
									<div class="row">
									...
									<div class="form-row">
										...
										<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-3">
											<div class="form-group">
												...
												<div>
													...
													<div class="custom-control custom-checkbox custom-control-inline">
														<input type="checkbox" name="sym_dyspnea_breathe" value="y" class="custom-control-input pt-type" id="sym_dyspnea_breathe" {{ old('sym_dyspnea_breathe') == 'y' ? 'checked' : ''}}>
													...
													<div class="custom-control custom-checkbox custom-control-inline">
														<input type="checkbox" name="sym_vomit" value="y" class="custom-control-input pt-type" id="sym_vomit" {{ old('sym_vomit') == 'y' ? 'checked' : ''}}>
														<label for="sym_vomit" class="custom-control-label normal-label">อาเจียน</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input type="checkbox" name="sym_diarrhoea" value="y" class="custom-control-input pt-type" id="sym_diarrhoea" {{ old('sym_diarrhoea') == 'y' ? 'checked' : ''}}>
														<label for="sym_diarrhoea" class="custom-control-label normal-label">ถ่ายเหลว</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input type="checkbox" onclick="check_uncheck_checkbox(this.checked)" name="sym_other" value="y" class="custom-control-input pt-type" id="sym_other" {{ old('sym_other') == 'y' ? 'checked' : ''}}>
										...
										<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
											<div class="form-group sym_othertext">
												...
												<input type="text" name="sym_othertext" id="sym_othertext" value="{{ old('sym_othertext') }}" class="form-control">
											</div>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-12">
											<div class="form-group">
												<label for="first_diag">แพทย์วินิจฉัยเบื้องต้น</label>
												<textarea class="form-control" name="first_diag" rows="3">{{ old('first_diag') }}</textarea>
											</div>
										</div>

										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-12">
											<div class="form-group">
												<label for="last_diag">แพทย์วินิจฉัยสุดท้าย</label>
												<textarea class="form-control" name="last_diag" rows="3">{{ old('last_diag') }}</textarea>
											</div>
										</div>
									</div>
