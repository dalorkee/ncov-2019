                            ...
                            <div class="container-fluid">
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-primary">อาการป่วย</label>
                                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-primary">ประวัติเสี่ยง</label>
                                                    <div class="col-md-9">
                                                        <div class="custom-control custom-checkbox mr-sm-2">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15 text-primary">ประเทศที่เดินทาง</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15 text-primary">จังหวัด</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15 text-primary">อำเภอ</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 m-t-15 text-primary">ตำบล</label>
                                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">	
                                                <label class="card-title text-success">ข้อมูลบุคคล</label>							
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">เลขบัตรประชาชน</label>
                                                            <input type="text" class="form-control" id="card_id" name="card_id" maxlength="13" pattern="[0-9]{13}">
                                                        </div>                                        
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hue-demo"  class="text-success">Passport</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">ชื่อ <span class="badge badge-danger">(ไม่ต้องมีคำนำหน้า)</span></label>
                                                            <input type="text" class="form-control" id="first_name" name="first_name" required>
                                                        </div>                                        
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">นามสกุล</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">อักษรภาษาอังกฤษตัวแรกของ ชื่อ</label>
                                                            <input type="text" class="form-control" id="first_name" name="fname_prefix" maxlength="1" placeholder="" pattern="[a-zA-Z]{1}" required>
                                                        </div>                                        
                                                    </div>
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">อักษรภาษาอังกฤษตัวแรกของ นามสกุล</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">เพศ</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">อายุ</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">สัญชาติ</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">เบอร์โทร</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">										
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">อาชีพ</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">ระบุอาชีพอื่นๆ</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">จังหวัด</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">อำเภอ</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-success">ตำบล</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-12">
                                                        <label for="hue-demo" class="text-danger">โรคประจำตัว</label>
                                                        <div class="custom-control custom-checkbox mr-sm-2">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-12">
                                                        <label for="hue-demo" class="text-danger">การตั้งครรภ์</label>
                                                        <div class="custom-control custom-checkbox mr-sm-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <label class="card-title text-danger">อาการป่วยและผลตรวจทางห้องปฏิบัติการ</label>
                                                <div class="row mb-3">
                                                    <div class="col-lg-4">
                                                        <label class="m-t-15 text-danger">วันเริ่มป่วย</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <label class="m-t-15 text-danger">จังหวัดสถานที่รักษา</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <label class="m-t-15 text-danger">สถานที่รักษา</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-danger">จังหวัด</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-danger">อำเภอ</label>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label for="hue-demo" class="text-danger">ตำบล</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-4">
                                                        <label class="m-t-15 text-danger">ผลตรวจทางห้องปฏิบัติการ <span class="badge badge-primary"> ครั้งที่1</span></label>	
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label for="hue-demo" class="text-danger">วันที่เก็บตัวอย่าง</label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <label for="hue-demo" class="text-danger">ชนิดตัวอย่าง</label>		
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-8">
                                                    <label for="hue-demo" class="text-danger">สถานที่ส่งตรวจ</label>	
                                                ...
                                                <div class="col-lg-4">
                                                    <label for="hue-demo" class="text-danger">วันที่ออกผลการตรวจ</label>	
                                                        <div class="input-group">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-4">
                                                    <label for="hue-demo" class="text-danger">ผลตรวจทางห้องปฏิบัติการ <span class="badge badge-primary"> ครั้งที่2</span></label>												
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="hue-demo" class="text-danger">วันที่เก็บตัวอย่าง</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control mydatepicker" placeholder="yyyy-mm-dd" name="lab_sars_cov2_no_2_date">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <label for="hue-demo" class="text-danger">ชนิดตัวอย่าง</label>		
                                                    <select class="select2 form-control custom-select" name="lab_sars_cov2_no_2_specimen">
                                                        <option value="">เลือกชนิดตัวอย่าง</option>                                                       
                                                        <option value="1">1</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-8">
                                                    <label for="hue-demo" class="text-danger">สถานที่ส่งตรวจ</label>	
                                                    <select class="select2 form-control custom-select" name="lab_sars_cov2_no_2_lab">
                                                        <option value="">เลือกสถานที่ตรวจ</option>                                                        
                                                        <option value="1">1</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="hue-demo" class="text-danger">วันที่ออกผลการตรวจ</label>	
                                                        <div class="input-group">
                                                            <input type="text" class="form-control mydatepicker" placeholder="yyyy-mm-dd" name="lab_sars_cov2_no_2_result_date">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                <div class="col-lg-6">
                                                    <label class="card-title text-info">การคัดกรอง</label>
